; Escribir un programa que cuente la cantidad de veces que se presiona la tecla F10. Cuando se presiona 10 veces, termina el programa.
...
; loop hasta que cantidad == 10
loop: cmp cantidad,10
	  jnz loop
