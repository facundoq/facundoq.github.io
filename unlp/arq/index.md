...
*   P4
    ...
    * Ejemplos
        ...
        * [Sumar elementos de un vector sin saltos ](ejemplos/p4e3.asm)
        * [Sumar elementos de un vector con saltos ](ejemplos/p4e4.asm)
        * [Máximo entre dos variables ](ejemplos/p4e5.asm)
        * [ Generar un vector de 5 elementos ](ejemplos/p4e6.asm)
        * [Multiplicar por dos los elementos del un vector ](ejemplos/p4e7.asm)
        * [Generar un nuevo vector a partir de uno existente ](ejemplos/p4e8.asm)
        * [Modificar los elementos de un vector mayores a 10 ](ejemplos/p4e9.asm)
        * [Calcular la suma de los valores de un vector utilizando un registro como puntero](ejemplos/p4e10.asm)
*   P5
