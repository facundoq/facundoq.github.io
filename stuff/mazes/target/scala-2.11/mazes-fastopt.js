...
function $s_s_math_Numeric$FloatIsConflicted$class__plus__s_math_Numeric$FloatIsConflicted__F__F__F($$this, x, y) {
  return $fround((x + y))
}
...
function $s_sc_TraversableLike$class__isEmpty__sc_TraversableLike__Z($$this) {
  ...
  $m_sc_Traversable$().breaks$3.breakable__F0__V(new $c_sc_TraversableLike$$anonfun$isEmpty$1().init___sc_TraversableLike__sr_BooleanRef($$this, result));
...
function $s_sc_TraversableLike$class__sliceWithKnownDelta__sc_TraversableLike__I__I__I__O($$this, from, until, delta) {
  var b = $$this.newBuilder__scm_Builder();
  return ((until <= from) ? b.result__O() : ($s_scm_Builder$class__sizeHint__scm_Builder__sc_TraversableLike__I__V(b, $$this, delta), $s_sc_TraversableLike$class__scala$collection$TraversableLike$$sliceInternal__sc_TraversableLike__I__I__scm_Builder__O($$this, from, until, b)))
}
...
function $s_sc_TraversableLike$class__copyToArray__sc_TraversableLike__O__I__I__V($$this, xs, start, len) {
  var i = new $c_sr_IntRef().init___I(start);
  var x = ((start + len) | 0);
  var that = $m_sr_ScalaRunTime$().array$undlength__O__I(xs);
  var end = ((x < that) ? x : that);
  $m_sc_Traversable$().breaks$3.breakable__F0__V(new $c_sc_TraversableLike$$anonfun$copyToArray$1().init___sc_TraversableLike__sr_IntRef__I__O($$this, i, end, xs))
}
...
function $s_sc_TraversableLike$class__scala$collection$TraversableLike$$sliceInternal__sc_TraversableLike__I__I__scm_Builder__O($$this, from, until, b) {
  var i = new $c_sr_IntRef().init___I(0);
  $m_sc_Traversable$().breaks$3.breakable__F0__V(new $c_sc_TraversableLike$$anonfun$scala$collection$TraversableLike$$sliceInternal$1().init___sc_TraversableLike__I__I__scm_Builder__sr_IntRef($$this, from, until, b, i));
  return b.result__O()
}
function $s_sc_TraversableLike$class__drop__sc_TraversableLike__I__O($$this, n) {
  if ((n <= 0)) {
    var b = $$this.newBuilder__scm_Builder();
    $s_scm_Builder$class__sizeHint__scm_Builder__sc_TraversableLike__V(b, $$this);
    return $as_scm_Builder(b.$$plus$plus$eq__sc_TraversableOnce__scg_Growable($$this.thisCollection__sc_Traversable())).result__O()
  } else {
    var delta = ((-n) | 0);
...
$c_Lmazes_generators_Position.prototype.adyacent__sc_Seq = (function() {
  ...
  var a = $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(xs, cbf));
  ...
  if ((bf === $m_sci_List$().ReusableCBFInstance$2)) {
    if ((a === $m_sci_Nil$())) {
      ...
      var t = h;
      var rest = $as_sci_List(a.tail__O());
    ...
    var b = $s_sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(a, bf);
    var these = a;
    while ((!these.isEmpty__Z())) {
...
$c_s_util_control_Breaks.prototype.breakable__F0__V = (function(op) {
  try {
    op.apply$mcV$sp__V()
  } catch (e) {
    if ($is_s_util_control_BreakControl(e)) {
      var ex = $as_s_util_control_BreakControl(e);
      if ((ex !== this.scala$util$control$Breaks$$breakException$1)) {
        throw ex
      }
    } else {
      throw e
...
$c_Lmazes_math_Categorical.prototype = new $h_Lmazes_math_Distribution();
$c_Lmazes_math_Categorical.prototype.constructor = $c_Lmazes_math_Categorical;
/** @constructor */
function $h_Lmazes_math_Categorical() {
  /*<skip>*/
}
$h_Lmazes_math_Categorical.prototype = $c_Lmazes_math_Categorical.prototype;
$c_Lmazes_math_Categorical.prototype.init___sci_List = (function(probabilities) {
  this.probabilities$2 = probabilities;
  return this
});
$c_Lmazes_math_Categorical.prototype.draw__I = (function() {
  var this$2 = this.probabilities$2;
  $m_sci_List$();
  $m_sci_List$();
  var b = new $c_scm_ListBuffer().init___();
  $s_scm_Builder$class__sizeHint__scm_Builder__sc_TraversableLike__I__V(b, this$2, 1);
  var elem$1 = null;
  elem$1 = 0.0;
  var elem = elem$1;
  b.$$plus$eq__O__scm_ListBuffer(elem);
  ...
  while ((!these.isEmpty__Z())) {
    ...
    var x$1 = $uF(arg1$1);
    var x$2 = $uF(arg1);
    elem$1 = $fround((x$1 + x$2));
    var elem$2 = elem$1;
    b.$$plus$eq__O__scm_ListBuffer(elem$2);
    these = $as_sci_List(these.tail__O())
  };
  var cumulativeProbabilities = b.toList__sci_List();
  var this$5 = new $c_s_util_Random().init___();
  var elem$3 = this$5.self$1.nextFloat__F();
  var elem$1$1 = 0.0;
  elem$1$1 = elem$3;
  inlinereturn$28: {
    var i = 0;
    var these$1 = cumulativeProbabilities.drop__I__sci_List(0);
    while (true) {
      var this$7 = these$1;
      if ($s_sc_TraversableOnce$class__nonEmpty__sc_TraversableOnce__Z(this$7)) {
        var arg1$2 = these$1.head__O();
        var x$3 = $uF(arg1$2);
        if ((x$3 > elem$1$1)) {
          var jsx$1 = i;
          break inlinereturn$28
        };
        i = ((1 + i) | 0);
...
var $d_Lmazes_math_Categorical = new $TypeData().initClass({
  Lmazes_math_Categorical: 0
}, false, "mazes.math.Categorical", {
  Lmazes_math_Categorical: 1,
  Lmazes_math_Distribution: 1,
  O: 1
});
...
}, false, "mazes.webapp.Main$", {
  Lmazes_webapp_Main$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_Lmazes_webapp_Main$.prototype.$classData = $d_Lmazes_webapp_Main$;
var $n_Lmazes_webapp_Main$ = (void 0);
function $m_Lmazes_webapp_Main$() {
  if ((!$n_Lmazes_webapp_Main$)) {
    $n_Lmazes_webapp_Main$ = new $c_Lmazes_webapp_Main$().init___()
  };
  return $n_Lmazes_webapp_Main$
}
$e.mazes = ($e.mazes || {});
...
$c_Lmazes_generators_BacktrackingMaze$$anonfun$6.prototype.apply__sci_List__Z = (function(c) {
  ...
  if ((bf === $m_sci_List$().ReusableCBFInstance$2)) {
    if ((c === $m_sci_Nil$())) {
      ...
      var h = new $c_sci_$colon$colon().init___O__sci_List(f(arg1), $m_sci_Nil$());
      var t = h;
      var rest = $as_sci_List(c.tail__O());
      while ((rest !== $m_sci_Nil$())) {
        var arg1$1 = rest.head__O();
        var nx = new $c_sci_$colon$colon().init___O__sci_List(f(arg1$1), $m_sci_Nil$());
        t.tl$5 = nx;
    ...
    var b = $s_sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(c, bf);
    var these = c;
    while ((!these.isEmpty__Z())) {
      var arg1$2 = these.head__O();
      b.$$plus$eq__O__scm_Builder(f(arg1$2));
  ...
  var op = new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function(x$2$2, x$3$2) {
    var x$2 = $uZ(x$2$2);
    var x$3 = $uZ(x$3$2);
    return (x$2 && x$3)
  }));
...
$c_sc_Iterator$$anon$9.prototype.init___F0 = (function(elem$3) {
...
/** @constructor */
function $c_sc_TraversableLike$$anonfun$copyToArray$1() {
...
$c_sc_TraversableLike$$anonfun$copyToArray$1.prototype = new $h_sr_AbstractFunction0$mcV$sp();
$c_sc_TraversableLike$$anonfun$copyToArray$1.prototype.constructor = $c_sc_TraversableLike$$anonfun$copyToArray$1;
/** @constructor */
function $h_sc_TraversableLike$$anonfun$copyToArray$1() {
  /*<skip>*/
}
$h_sc_TraversableLike$$anonfun$copyToArray$1.prototype = $c_sc_TraversableLike$$anonfun$copyToArray$1.prototype;
$c_sc_TraversableLike$$anonfun$copyToArray$1.prototype.init___sc_TraversableLike__sr_IntRef__I__O = (function($$outer, i$3, end$1, xs$1) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$3 = $$outer
...
$c_sc_TraversableLike$$anonfun$copyToArray$1.prototype.apply$mcV$sp__V = (function() {
  this.$$outer$3.foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this) {
    return (function(x$2) {
      if (($this.i$3$3.elem$1 >= $this.end$1$3)) {
        $m_sc_Traversable$().breaks$3.$break__sr_Nothing$()
      };
      $m_sr_ScalaRunTime$().array$undupdate__O__I__O__V($this.xs$1$3, $this.i$3$3.elem$1, x$2);
      $this.i$3$3.elem$1 = ((1 + $this.i$3$3.elem$1) | 0)
    })
  })(this)))
});
$c_sc_TraversableLike$$anonfun$copyToArray$1.prototype.apply__O = (function() {
  this.apply$mcV$sp__V()
});
var $d_sc_TraversableLike$$anonfun$copyToArray$1 = new $TypeData().initClass({
  sc_TraversableLike$$anonfun$copyToArray$1: 0
}, false, "scala.collection.TraversableLike$$anonfun$copyToArray$1", {
  sc_TraversableLike$$anonfun$copyToArray$1: 1,
...
$c_sc_TraversableLike$$anonfun$copyToArray$1.prototype.$classData = $d_sc_TraversableLike$$anonfun$copyToArray$1;
/** @constructor */
function $c_sc_TraversableLike$$anonfun$isEmpty$1() {
  $c_sr_AbstractFunction0$mcV$sp.call(this);
  this.$$outer$3 = null;
  this.result$1$3 = null
}
$c_sc_TraversableLike$$anonfun$isEmpty$1.prototype = new $h_sr_AbstractFunction0$mcV$sp();
$c_sc_TraversableLike$$anonfun$isEmpty$1.prototype.constructor = $c_sc_TraversableLike$$anonfun$isEmpty$1;
/** @constructor */
function $h_sc_TraversableLike$$anonfun$isEmpty$1() {
  /*<skip>*/
}
$h_sc_TraversableLike$$anonfun$isEmpty$1.prototype = $c_sc_TraversableLike$$anonfun$isEmpty$1.prototype;
$c_sc_TraversableLike$$anonfun$isEmpty$1.prototype.init___sc_TraversableLike__sr_BooleanRef = (function($$outer, result$1) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$3 = $$outer
...
$c_sc_TraversableLike$$anonfun$isEmpty$1.prototype.apply$mcV$sp__V = (function() {
  this.$$outer$3.foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this) {
    return (function(x$2) {
      $this.result$1$3.elem$1 = false;
      $m_sc_Traversable$().breaks$3.$break__sr_Nothing$()
    })
  })(this)))
});
$c_sc_TraversableLike$$anonfun$isEmpty$1.prototype.apply__O = (function() {
  this.apply$mcV$sp__V()
});
var $d_sc_TraversableLike$$anonfun$isEmpty$1 = new $TypeData().initClass({
  sc_TraversableLike$$anonfun$isEmpty$1: 0
}, false, "scala.collection.TraversableLike$$anonfun$isEmpty$1", {
  sc_TraversableLike$$anonfun$isEmpty$1: 1,
  sr_AbstractFunction0$mcV$sp: 1,
  sr_AbstractFunction0: 1,
  O: 1,
  F0: 1,
...
$c_sc_TraversableLike$$anonfun$isEmpty$1.prototype.$classData = $d_sc_TraversableLike$$anonfun$isEmpty$1;
/** @constructor */
function $c_sc_TraversableLike$$anonfun$scala$collection$TraversableLike$$sliceInternal$1() {
  $c_sr_AbstractFunction0$mcV$sp.call(this);
  this.$$outer$3 = null;
  this.from$1$3 = 0;
  this.until$1$3 = 0;
...
$c_sc_TraversableLike$$anonfun$scala$collection$TraversableLike$$sliceInternal$1.prototype = new $h_sr_AbstractFunction0$mcV$sp();
$c_sc_TraversableLike$$anonfun$scala$collection$TraversableLike$$sliceInternal$1.prototype.constructor = $c_sc_TraversableLike$$anonfun$scala$collection$TraversableLike$$sliceInternal$1;
/** @constructor */
function $h_sc_TraversableLike$$anonfun$scala$collection$TraversableLike$$sliceInternal$1() {
  /*<skip>*/
}
$h_sc_TraversableLike$$anonfun$scala$collection$TraversableLike$$sliceInternal$1.prototype = $c_sc_TraversableLike$$anonfun$scala$collection$TraversableLike$$sliceInternal$1.prototype;
$c_sc_TraversableLike$$anonfun$scala$collection$TraversableLike$$sliceInternal$1.prototype.init___sc_TraversableLike__I__I__scm_Builder__sr_IntRef = (function($$outer, from$1, until$1, b$9, i$1) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$3 = $$outer
  };
  this.from$1$3 = from$1;
  this.until$1$3 = until$1;
  this.b$9$3 = b$9;
  this.i$1$3 = i$1;
  return this
});
$c_sc_TraversableLike$$anonfun$scala$collection$TraversableLike$$sliceInternal$1.prototype.apply$mcV$sp__V = (function() {
  this.$$outer$3.foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this) {
    return (function(x$2) {
      if (($this.i$1$3.elem$1 >= $this.from$1$3)) {
        $this.b$9$3.$$plus$eq__O__scm_Builder(x$2)
      };
      $this.i$1$3.elem$1 = ((1 + $this.i$1$3.elem$1) | 0);
      if (($this.i$1$3.elem$1 >= $this.until$1$3)) {
        $m_sc_Traversable$().breaks$3.$break__sr_Nothing$()
      }
    })
  })(this)))
});
$c_sc_TraversableLike$$anonfun$scala$collection$TraversableLike$$sliceInternal$1.prototype.apply__O = (function() {
  this.apply$mcV$sp__V()
});
var $d_sc_TraversableLike$$anonfun$scala$collection$TraversableLike$$sliceInternal$1 = new $TypeData().initClass({
  sc_TraversableLike$$anonfun$scala$collection$TraversableLike$$sliceInternal$1: 0
}, false, "scala.collection.TraversableLike$$anonfun$scala$collection$TraversableLike$$sliceInternal$1", {
  sc_TraversableLike$$anonfun$scala$collection$TraversableLike$$sliceInternal$1: 1,
  sr_AbstractFunction0$mcV$sp: 1,
  sr_AbstractFunction0: 1,
  O: 1,
  F0: 1,
...
$c_sc_TraversableLike$$anonfun$scala$collection$TraversableLike$$sliceInternal$1.prototype.$classData = $d_sc_TraversableLike$$anonfun$scala$collection$TraversableLike$$sliceInternal$1;
/** @constructor */
...
$c_scm_ArraySeq$.prototype.init___ = (function() {
  $c_scg_GenTraversableFactory.prototype.init___.call(this);
  return this
});
...
$c_Lmazes_generators_Matrix.prototype.toString__T = (function() {
  ...
  var i = 0;
  while ((i < this$2.length$5)) {
    var arg1 = this$2.array$5.u[i];
    var x$21 = $as_scm_ArraySeq(arg1);
    var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$22$2) {
      return $objectToString(x$22$2)
    }));
    var this$3 = $m_scm_ArraySeq$();
    var bf$1 = this$3.ReusableCBFInstance$2;
    b.$$plus$eq__O__scm_Builder($as_sc_TraversableOnce($s_sc_TraversableLike$class__map__sc_TraversableLike__F1__scg_CanBuildFrom__O(x$21, f, bf$1)).mkString__T__T(" "));
    i = ((1 + i) | 0)
  };
  ...
  if ((!isEmpty$4)) {
    ...
    while (true) {
      ...
      if ((!isEmpty$4$1)) {
        ...
        while (true) {
          var arg1 = i$2;
          f.apply__O__O(this.apply__I__I__O(i$1, arg1));
...
/** @constructor */
function $h_s_math_Numeric$FloatIsFractional$() {
  /*<skip>*/
}
...
function $m_s_math_Numeric$FloatIsFractional$() {
...
$c_sc_AbstractSeq.prototype.indexWhere__F1__I = (function(p) {
...
$c_Lscalatags_JsDom$all$.prototype.pre__Lscalatags_generic_TypedTag = (function() {
  var b = this.bitmap$0$1;
...
$c_Lscalatags_JsDom$all$.prototype.pre$lzycompute__p1__Lscalatags_generic_TypedTag = (function() {
  ...
  if ((lo === 0)) {
    var ns = $m_Lscalatags_generic_Namespace$().htmlNamespaceConfig$1;
    this.pre$1 = $s_Lscalatags_jsdom_TagFactory$class__typedTag__Lscalatags_jsdom_TagFactory__T__Z__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag(this, "pre", false, ns);
    var b$1 = this.bitmap$0$1;
...
$c_scm_ArraySeq.prototype.indexWhere__F1__I__I = (function(p, from) {
  return $s_sc_IndexedSeqOptimized$class__indexWhere__sc_IndexedSeqOptimized__F1__I__I(this, p, from)
});
...
function $is_scm_ArraySeq(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.scm_ArraySeq)))
}
function $as_scm_ArraySeq(obj) {
  return (($is_scm_ArraySeq(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "scala.collection.mutable.ArraySeq"))
}
...
$c_scm_ListBuffer.prototype.indexWhere__F1__I = (function(p) {
  var this$1 = this.scala$collection$mutable$ListBuffer$$start$6;
  return $s_sc_LinearSeqOptimized$class__indexWhere__sc_LinearSeqOptimized__F1__I__I(this$1, p, 0)
});
...
//# sourceMappingURL=mazes-fastopt.js.map
